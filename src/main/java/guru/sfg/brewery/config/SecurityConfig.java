...
import guru.sfg.brewery.security.AbstractAuthFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public AbstractAuthFilter restHeaderAuthFilter(AuthenticationManager authenticationManager){
        RestHeaderAuthFilter filter = new RestHeaderAuthFilter(new AntPathRequestMatcher("/api/**"));
        filter.setAuthenticationManager(authenticationManager);
        return filter;
    }

    public AbstractAuthFilter urlParamAuthFilter(AuthenticationManager authenticationManager){
        AbstractAuthFilter filter = new URLParamAuthFilter(new AntPathRequestMatcher("/api/**"));
        filter.setAuthenticationManager(authenticationManager);
        return filter;
    }
    @Override
